  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'float-sparkle': 'float-sparkle 12s infinite linear',
        'float-sparkle-slow': 'float-sparkle-slow 15s infinite linear',
      },
      keyframes: {
        float: {
        ...
        'ember-glow': {
          '0%, 100%': { boxShadow: '0 0 0px rgba(212,95,0,0)' },
          '50%': { boxShadow: '0 0 30px rgba(212,95,0,0.3), 0 0 60px rgba(139,0,0,0.12)' },
        },
      },
      backgroundImage: {
